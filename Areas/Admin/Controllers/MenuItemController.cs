...
namespace YZU.Areas.Admin.Controllers
{
    ...
    public class MenuItemController : Controller
    {
        ...
        public async Task<IActionResult> CreatePOST()
        {
            ...
            else
            {
                ...
                var uploads = Path.Combine(webRootPath, @"images\" + SD.DefaultCourseImage);
        ...
        public async Task<IActionResult> EditPOST(int? id)
        {
            ...
            menuItemFromDb.Difficulty = MenuItemVM.MenuItem.Difficulty;
