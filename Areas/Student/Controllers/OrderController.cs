...
namespace YZU.Areas.Customer.Controllers
{
    [Area("Student")]
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderHistory(int productPage = 1)
        {
            ...
            orderListVM.PagingInfo = new PagingInfo
            {
                ...
                TotalItem = count,
                urlParam = "/Student/Order/OrderHistory?productPage=:"
            };

            return View(orderListVM);
        }

        [Authorize(Roles = SD.TeacherUser + "," + SD.ManagerUser)]
        ...
        public async Task<IActionResult> OrderPickup(int productPage = 1, string searchEmail = null, string searchPhone = null, string searchName = null)
        {
            ...
            param.Append("/Student/Order/OrderPickup?productPage=:");
